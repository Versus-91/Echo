...
{
    public abstract class EchoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EchoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EchoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EchoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EchoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EchoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EchoDbContext, Task<T>> func)
        {
            T result;
